...
<P align="right">
    <a href="/admin/facility/add/">Add Facility</a>
</P>
<p align="right"><?= $rec_now ?> of total: <?= $total ?></p>
<form action="/admin/facility/delete/selected/" onSubmit="javascript:return chk_del('Facilty', this);" name="form1" method="post">
    ...
    if ($total > 0)
        print '
            ...
            <input type="hidden" name="FormAction" value="del_del_sel">
 				...
 				<input class="sbttn" type="submit" name="sbtn" value="Delete Facility(s)">
      	</p>
     	</form>';
    print '
